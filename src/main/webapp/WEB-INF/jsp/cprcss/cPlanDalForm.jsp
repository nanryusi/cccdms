...
<section class="main">
<div class="sm_title">보육일지</div>
<form:form commandName="CplanDalVo" name="actionForm" method="post" enctype="multipart/form-data" >
    <form:hidden path="idx"/>
    <table class="bbs_write">
        <caption>보육일지</caption>
        <colgroup>
            <col width="15%">
            <col width="15%">
            <col width="15%">
        ...
        <tr>
            <th scope="row">기간</th>
            <td colspan="2">
                <input type="date" id="startDay" value="<c:out value="${CplanDalVo.startDay}"/>">
                ~
                <input type="date" id="endDay" value="<c:out value="${CplanDalVo.endDay}"/>">
            </td>
...
<div class="form_btn">
    <div class="right">
        <ul>
            <c:if test="${CplanDalVo.pathVariable eq 'insert' }">
                <li><a class="btn_l btn_focus" href="#" id="btn_add_ajax">입력</a></li>
            </c:if>
            <c:if test="${CplanDalVo.pathVariable eq 'update' }">
...
<script type="text/javascript" src="/static/js/cccdms/cprcss/cPlanDalForm.js"></script>
</body>
</html>
