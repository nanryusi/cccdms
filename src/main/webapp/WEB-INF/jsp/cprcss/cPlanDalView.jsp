...
<form:form commandName="CplanDalDtlVo" name="viewForm" method="post" enctype="multipart/form-data" >
    ...
    <table class="bbs_write">
        ...
        <tr>
            <th scope="row">기간</th>
            <td colspan="2">
                <input type="date" id="startDay" value="<c:out value="${CplanDalDtlVo.startDay}"/>">
                ~
                <input type="date" id="endDay" value="<c:out value="${CplanDalDtlVo.endDay}"/>">
            </td>
