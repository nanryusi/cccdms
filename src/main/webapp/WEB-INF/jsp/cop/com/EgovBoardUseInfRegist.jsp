				...
				<form:form commandName="boardUseInf" name="boardUseInf" method="post">
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr> 
                          <td><a href="#LINK" onclick="fn_egov_regist_bbsUseInf(); "><spring:message code="button.create" /></a>
                          </td>
					      <td width="10"></td>
                          <td><a href="<c:url value='/cop/com/selectBBSUseInfs.do'/>?searchCondition=1" onclick="fn_egov_select_bbsUseInfs(); return false;"><spring:message code="button.list" /></a>
					      </td>  
                        </tr>
                      </table>
                    </div>
