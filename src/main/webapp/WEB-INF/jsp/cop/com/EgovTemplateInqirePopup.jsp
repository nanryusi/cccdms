...
<form name="frm" action ="<c:url value='/cop/com/selectTemplateInfsPop.do'/>" method="post">
                ...
                <ul id="search_second_ul">
                    <li>
                        <div class="buttons" style="position:absolute;left:700px;top:47px;">
                            <a href="<c:url value='/cop/com/selectTemplateInfsPop.do'/>" onclick="fn_egov_select_tmplatInfo('1'); return false;"><img src="<c:url value='/images/img_search.gif' />" alt="search" />조회 </a>
                        </div>                              
                    </li>
                </ul>           
            </div>          
	...
	<div class="buttons" align="center" >
		<table border="0" cellspacing="0" cellpadding="0" align="center">
			<tr> 
				<td><a href="#LINK" onclick="parent.close(); return false;">닫기</a></td>
			</tr>
		</table>	
	</div>
</form>
