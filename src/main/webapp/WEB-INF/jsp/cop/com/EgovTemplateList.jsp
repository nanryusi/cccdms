                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:182px;">
                                        <a href="<c:url value='/cop/com/selectTemplateInfs.do'/>" onclick="fn_egov_select_tmplatInfo('1'); return false;"><img src="<c:url value='/images/img_search.gif" alt="search' />" />조회 </a>
                                        <a href="<c:url value='/cop/com/addTemplateInf.do'/>" onclick="fn_egov_insert_addTmplatInfo(); return false;">등록</a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
