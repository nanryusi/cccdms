				...
				<form:form commandName="templateInf" name="templateInf" method="post" >
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr> 
                          <td>
                              <a href="#LINK" onclick="fn_egov_update_tmplatInfo(); return false;"><spring:message code="button.save" /></a>
                          </td>
                          <td width="10"></td>
                          <td>
                              <a href="<c:url value='/cop/com/selectTemplateInfs.do'/>" onclick="fn_egov_select_tmplatInfo(); return false;"><spring:message code="button.list" /></a>
                          </td>
                          <td width="10"></td>
                          <td>
                              <a href="#LINK" onclick="fn_egov_previewTmplat(); return false;" title="새창" ><spring:message code="cop.preview" /></a>
                          </td>  
                        </tr>
                      </table>
                    </div>
