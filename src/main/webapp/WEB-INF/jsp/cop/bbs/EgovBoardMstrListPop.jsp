                ...
                <ul id="search_first_ul">
                    ...
                    <li>
                        <div class="buttons" style="float:right;">
                            <a href="<c:url value='/cop/bbs/SelectBBSMasterInfsPop.do'/>" onclick="fn_egov_select_brdMstr('1'); return false;"><img src="<c:url value='/images/img_search.gif' />" alt="search" />조회 </a>
                        </div>                              
                    </li>   
                </ul>
            </div>          
