                ...
                <div id="search_field">
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              <td><a href="#LINK" onclick="fn_egov_update_brdMstr(); return false;"><spring:message code="button.save" /></a>
                              </td>
                              <td>&nbsp;&nbsp;</td>
                              <td><a href="#LINK" onclick="fn_egov_delete_brdMstr(); return false;"><spring:message code="button.delete" /></a></td>
                              <td>&nbsp;&nbsp;</td>
                              <td><a href="<c:url value='/cop/bbs/SelectBBSMasterInfs.do'/>" onclick="fn_egov_select_brdMstrList(); return false;"><spring:message code="button.list" /></a>
                              </td>
                            </tr>   
                        </table>
                    </div>
