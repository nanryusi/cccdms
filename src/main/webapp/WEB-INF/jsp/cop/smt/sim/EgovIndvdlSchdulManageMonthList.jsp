                ...
                <input type="submit" id="invisible" class="invisible"/>
	                ...
	                <!-- 날짜 네비게이션  -->
						...
						for(int index = 1; index <= endDay; index++) {
						    ...
						    sUseDate += Integer.toString(index).length() == 1 ? "0" + index : Integer.toString(index);
						    ...
						    if(listResult != null){
						        ...
						        for(int i=0;i < listResult.size(); i++){
						            ...
						            if(iUseDate >= iBeginDate && iUseDate <= iBeginEnd){
						                ...
						                out.println("<a href=\"EgovIndvdlSchdulManageDetail.do?schdulId="+ egovMap.get("schdulId") +"\" target=\"_top\">");
