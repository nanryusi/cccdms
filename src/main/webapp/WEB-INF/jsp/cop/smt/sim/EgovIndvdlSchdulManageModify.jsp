                ...
                <form:form commandName="indvdlSchdulManageVO" action="/cop/smt/sim/EgovIndvdlSchdulManageModifyActor.do" method="post" enctype="multipart/form-data">
                    <div class="modify_user" >
	                    ...
	                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
							...
							<tr> 
							  <td>
							     <a href="<c:url value='/'/>/cop/smt/sim/EgovIndvdlSchdulManageMonthList.do" onclick="fn_egov_list_IndvdlSchdulManage(); return false;"><spring:message code="button.list" /></a>
							  </td>
							  <td width="10"></td>
							  <td>
							     <a href="#LINK" onclick="fn_egov_save_IndvdlSchdulManage(); return false;"><spring:message code="button.save" /></a>
							  </td>
							</tr>
							</table>
	                    </div>
