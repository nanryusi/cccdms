            ...
            <div id="content">
                ...
                <form:form commandName="indvdlSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/sim/EgovIndvdlSchdulManageRegistActor.do" name="indvdlSchdulManageVO" method="post" enctype="multipart/form-data">
                    ...
                    <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                        ...
                        <tr> 
                          <td>
                              <a href="${pageContext.request.contextPath}/cop/smt/sim/EgovIndvdlSchdulManageMonthList.do" onclick="fn_egov_list_IndvdlSchdulManage(); return false;"><spring:message code="button.list" /></a>
                          </td>
                          <td>
                              <a href="#LINK" onclick="fn_egov_save_IndvdlSchdulManage();"><spring:message code="button.save" /></a>
                          </td>  
                        </tr>
                        </table>
                    </div>
