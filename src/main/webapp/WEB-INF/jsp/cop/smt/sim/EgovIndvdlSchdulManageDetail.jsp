...
<%
String sLinkType = request.getParameter("linkType") == null ? "" : request.getParameter("linkType");
%>
			...
			<div id="content">
                ...
                <input type="submit" id="invisible" class="invisible"/>
					...
					<div class="buttons" style="padding-top:10px;padding-bottom:10px;">
						...
						<tr> 
						  <td>
						      <a href="#LINK" onclick="fn_egov_list_IndvdlSchdulManage(); return false;"><spring:message code="button.list" /></a>
						  </td>
						  <td width="10"></td>
						  <td>
						      <% if(null != session.getAttribute("LoginVO")){ %>
						      <a href="#LINK" onclick="fn_egov_delete_IndvdlSchdulManage(); return false;"><spring:message code="button.delete" /></a>
						      <% } %>
						  </td>
                          <td width="10"></td>
						  <td>
						  <% if(null != session.getAttribute("LoginVO")){ %>
						      <a href="#LINK" onclick="fn_egov_modify_IndvdlSchdulManage(); return false;"><spring:message code="button.update" /></a>
						  <% }%>
						  </td>
						</tr>
						</table>
