...
public interface EgovBBSAttributeManageService {
  ...
  void deleteBBSMasterInf(BoardMaster boardMaster)
	 ...
	 * @exception Exception Exception
	 */
  String insertBBSMastetInf(BoardMaster boardMaster)
	  throws Exception;
	 ...
	 * @exception Exception Exception
	 */
  List<BoardMasterVO> selectAllBBSMasteInf(BoardMasterVO vo)
	  throws Exception;
  ...
  BoardMasterVO selectBBSMasterInf(BoardMaster searchVO)
	 ...
	 * @exception Exception Exception
	 */
  Map<String, Object> selectBBSMasterInfs(BoardMasterVO searchVO)
	  throws Exception;
	 ...
	 * @exception Exception Exception
	 */
  Map<String, Object> selectBdMstrListByTrget(BoardMasterVO vo)
	  throws Exception;
	 ...
	 * @exception Exception Exception
	 */
  Map<String, Object> selectNotUsedBdMstrList(BoardMasterVO vo)
	  throws Exception;
  ...
  void updateBBSMasterInf(BoardMaster boardMaster)
	 ...
	 * @exception Exception Exception
	 */
  void validateTemplate(BoardMasterVO searchVO)
	  throws Exception;
