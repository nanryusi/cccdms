...
public class EgovIndvdlSchdulManageController {
    ...
    throws Exception {
		...
		****************************************************************** */
		...
		for(int i=1; i <= endDay; i++)
		{
			...
			sUseDate += Integer.toString(iNowMonth+1).length() == 1 ? "0" + (iNowMonth + 1) : Integer.toString(iNowMonth+1);
			sUseDate += Integer.toString(i).length() == 1 ? "0" + i : Integer.toString(i);
    ...
    throws Exception {
		...
		//int iDate = cal.get(java.util.Calendar.DATE);
                ...
                if(sYear == null || sMonth == null){
                        ...
                        sSearchDate += Integer.toString(iMonth+1).length() == 1 ? "0" + (iMonth + 1) : Integer.toString(iMonth+1);
                }else{
    ...
    throws Exception {
    	...
    	Boolean isAuthenticated = request.getSession().getAttribute("LoginVO") != null;
    	if(!isAuthenticated) {
